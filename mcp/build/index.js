...
import { getSigner, getTokenDecimals } from "./helpers.js";
...
// Helper functions
// -------------------------------------------
async function tokenTransfer(wh, route) {
...
server.tool("transferTokens", {
    ...
    address: z
        .string()
        .describe("Address to transfer (e.g., '0x0cCEb44dbbAF7dE58D8D0e12c93cbE553f0d6Ebf')"),
